...
_oscr_socre_net1 = evaluation.compute_oscr(xK_net1, xU_net1, yK_net1)
_oscr_socre_net2 = evaluation.compute_oscr(xK_net2, xU_net2, yK_net2)

OSCR_score_net1 = _oscr_socre_net1 * 100
OSCR_score_net2 = _oscr_socre_net2 * 100

print("net1 OSCR (%): {:.3f}\t".format(OSCR_score_net1))
print("net2 OSCR (%): {:.3f}\t".format(OSCR_score_net2))
